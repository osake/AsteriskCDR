...
<head>
  ...
  <spring:url value="/resources/dist/css/skins/skin-blue.min.css" var="skinblue"/>
  ...
  <spring:url value="/resources/dist/js/app.min.js" var="app"/>
  <spring:url value="/resources/dist/img/user2-160x160.jpg" var="user2"/>
  ...
  -->
  <link href="${skinblue}" rel="stylesheet"/>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Oregon</b>CRM</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="${user2}" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="${user2}" class="user-image" alt="User Image">
